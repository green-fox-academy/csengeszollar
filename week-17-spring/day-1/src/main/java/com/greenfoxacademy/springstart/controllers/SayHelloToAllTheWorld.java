...
public class SayHelloToAllTheWorld {
    ...
    String[] greetings = {"Mirëdita", "Ahalan", "Parev", "Zdravei", "Nei Ho", "Dobrý den", "Ahoj", "Goddag", "Goede dag, Hallo", "Hello", "Saluton", "Hei", "Bonjour",
    ...
    public String greeting(@RequestParam String color, @RequestParam Integer size, Model model) {
        ...
        return "greetingOnDifferentLanguages";
    }
